...
class TestDraw:
    def test_fifty_moves_one(self):
        ...
        # Adicionando pecas default ao tabuleiro
        board.pecas_tabuleiro = board.reseta_tabuleiro()
        board.pecas_tabuleiro[1] = [
            None for x in range(8)]  # Retirando os peoes
        board.pecas_tabuleiro[6] = [
            None for x in range(8)]  # Retirando os peoes
        ...
        for i in range(50):
            if i % 4 == 0:
                ...
                board.validate_click(
                    coords_first_click[1] * tile_length, coords_first_click[0] * tile_length)
                board.validate_click(
                    coords_second_click[1] * tile_length, coords_second_click[0] * tile_length)
